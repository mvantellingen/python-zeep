...
def test_xml_simple_content_nil_allow_nil():
    schema = xsd.Schema(load_xml("""
        ...
        <schema xmlns="http://www.w3.org/2001/XMLSchema"
                ...
                targetNamespace="http://tests.python-zeep.org/"
                elementFormDefault="qualified">
          <element name="container" nillable="true" minOccurs="0" maxOccurs="unbounded">
            <complexType>
              <simpleContent>
                <restriction base="string">
                  <maxLength value="1000"/>
    ...
    obj = container_elm.parse(result[0], schema, allow_none=True)
    assert obj is None
