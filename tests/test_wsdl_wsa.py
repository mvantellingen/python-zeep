...
def test_wsdl_import(recwarn, monkeypatch):
    monkeypatch.setattr(
    ...
    envelope, headers = binding._create(
        ...
        kwargs={},
        client=client,
        endpoint_url='http://tests.python-zeep.org/test')
    expected = """
        <soap-env:Envelope
            xmlns:ns0="http://tests.python-zeep.org/xsd-main"
