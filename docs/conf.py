...
intersphinx_mapping = {"requests": ("http://requests.readthedocs.io/en/master/", None)}
...
latex_documents = [
    (master_doc, "Zeep.tex", "Zeep Documentation", "Michael van Tellingen", "manual"),
]
...
man_pages = [(master_doc, "zeep", "Zeep Documentation", [author], 1)]
