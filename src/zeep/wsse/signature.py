...
class MemorySignature:
    ...
    def __init__(
        ...
        self.cert_public_key_verify = cert_public_key_verify
    ...
    def verify(self, envelope):
        if self.verify_response:
            key = _make_verify_key(self.cert_public_key_verify)
...
class Signature(MemorySignature):
    ...
    def __init__(
        ...
        super().__init__(
            _read_file(key_file),
            _read_file(certfile),
            _read_file(cert_public_key_verify_file),
            verify_response,
            password,
            signature_method,
            digest_method,
